...
ec_title <- paste0("\\small Economic Contribution$^4$ (Year ended March ", ec_year, ")")
...
Data_S_7 <- paste0("$^7$New Zealand's Tourism Sector Outlook: Forecasts for ", Fcst_year, " to ", End_year, ".")
